...
public class AIPlayer extends Player {
    ...
    /**
     * This constructor takes a difficulty nad sets it.
     * @param aDifficulty
     */
    ...
    /**
     *Constructor that takes an AIplayer as a paramater
    ...
    /**
     *Setter that sets the game difficulty
    ...
    /**
     *A method that takes a GameSet and Board, puts them in an arraylist
     * then gives the AI coordinates to choose from
     * @param currentGameSet
     * @param currentBoard
     * @return Coord
     */
    ...
    /**
     *Generates the possible moves fro the AI
     * @param pieces
     * @param aBoard
     * @return
     */
    ...
    /**
     *Chooses a random move given the amount of moves that the piece has to work with.
     * @param pieces
     * @param givenMoves
     * @return
     */
