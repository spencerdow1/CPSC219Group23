...
public class ApocalypseClick implements EventHandler<MouseEvent> {
    ...
    /**
     * The constructor for apocalypse click sets dimensions and scene
     * @param dimX
     * @param dimY
     * @param root
     * @param name1
    ...
    /**
     * Setts the selection of the piece
    ...
    /**
     * Getter for the whitepiece selection
     * @return Coord
     */
    ...
    /**
     * Getter for the black piece move
     * @return Coord
     */
    ...
    /**
     * Updates the visual board to correspond to the current gameset
     * @param gameDynamics
     * @param gameSet
     * @param board
     */
    ...
    /**
     * Sets the highlighted piece once the piece is selected
