...
/** This is a convenience class for dealing with two tuples of integers
for use in the Apocalypse board. There are no restrictions on allowed x and y
values. Simple add function will accept negative values for a subtraction
**/
public class Coord {

    /** While the coord variable is held private, x and y are set to public
    for syntactic convenience elsewhere in Apocalpyse
    **/
    public int x;
    public int y;
    ...
    **/
    ...
    /** Simple add function. Will accept negative values for a subtraction
    @param <someCoord>: Argument is given in coordinates for syntactic convenience
    **/
    ...
    **/
    ...
    @see setYCoord()
    **/
    private void setCoords(int anyX, int anyY){
        setXCoord(anyX);
        setYCoord(anyY);
    }
